...
to set-globals [vision-val minimum-separation-val max-align-turn-val max-cohere-turn-val max-separate-turn-val]
  set vision vision-val
  set minimum-separation minimum-separation-val
  set max-align-turn max-align-turn-val
  set max-cohere-turn max-cohere-turn-val
...
to set-globals-circular
  set-globals 20 1 0 20 20
end

to set-globals-random
